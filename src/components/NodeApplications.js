...
function NodeApplications(props){
    ...
    return (
        <div>
            <h2>Nodejs Developers</h2>
            <h2>List of people applied for Nodejs Developer's job</h2>
...
export default connect(mapStateToProps)(NodeApplications)