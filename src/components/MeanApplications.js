...
function MeanStackApplications(props){
    ...
    return (
        <div>
            ...
            <h2>List of people applied for Mean stack Developer's job</h2>
...
export default connect(mapStateToProps)(MeanStackApplications)