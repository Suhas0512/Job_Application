...
function FullStackApplications(props){
    ...
    return (
        <div>
            ...
            <h2>List of people applied for Front stack Developer's job</h2>
...
export default connect(mapStateToProps)(FullStackApplications)